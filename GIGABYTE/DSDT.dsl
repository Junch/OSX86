 ...
 * 
 * Disassembly of C:\Users\Jun\Downloads\DSDT Editor\DSDT Editor & Patcher\2012.5.17 更新\0.8 版本\Linux + Windows\DSDTEditor-Linux-Mac-Win\dsdt.aml, Wed Apr 26 19:21:43 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000095D4 (38356)
 *     Revision         0x02
 *     Checksum         0xE6
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("C:\Users\Jun\Downloads\DSDT Editor\DSDT Editor & Patcher\2012.5.17 更新\0.8 版本\Linux + Windows\DSDTEditor-Linux-Mac-Win\dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDE7E3E18, 0x01CD)
            ...
            Device (LPCB)
            {
                ...
                Device (SIO1)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        ...
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y11._MIN, IOIM)
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y11._MAX, IOIX)
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y11._LEN, IOIL)
                            Store (SP1O, IOIM)
                            Store (SP1O, IOIX)
                            Store (0x02, IOIL)
                        }
                        ...
                        If (GPIB)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y12._MIN, GP0M)
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y12._MAX, GP0X)
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y12._LEN, GP0L)
                            Store (GPIB, GP0M)
                            Store (GPIB, GP0X)
                            Store (GPIL, GP0L)
                        }
                        ...
                        If (HWMB)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._MIN, HW0M)
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._MAX, HW0X)
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y13._LEN, HW0L)
                            Store (HWMB, HW0M)
                            Store (HWMB, HW0X)
                            Store (HWML, HW0L)
                        }
                        ...
                        If (PMEB)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y14._MIN, PM0M)
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y14._MAX, PM0X)
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y14._LEN, PM0L)
                            Store (PMEB, PM0M)
                            Store (PMEB, PM0X)
                            Store (PMEL, PM0L)
                        }
                    ...
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1C._INT, IRQL)
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1D._MIN, IOHL)
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1D._MAX, IORL)
                    CreateByteField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1D._ALN, ALMN)
                    CreateByteField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1D._LEN, LENG)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDE6C2F98, 0x10)
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1E._BAS, RBR0)
                ShiftLeft (^^LPCB.RCBA, 0x0E, RBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1F._BAS, TBR0)
                Store (TBAB, TBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y1F._LEN, TBLN)
                If (LEqual (TBAB, Zero))
                {
                    Store (Zero, TBLN)
                }

                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y20._BAS, MBR0)
                ShiftLeft (MHBR, 0x0F, MBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y21._BAS, DBR0)
                ShiftLeft (DIBR, 0x0C, DBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y22._BAS, EBR0)
                ShiftLeft (EPBR, 0x0C, EBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y23._BAS, XBR0)
                ShiftLeft (PXBR, 0x1A, XBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y23._LEN, XSZ0)
